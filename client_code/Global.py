...
#
# for every table we need an entry in this multi-level dictionary. There is one entry for all find specialists tables (fs tables), so for these there is no need for a entry per fs table.
# 
role_access = {
'Site Viewer': {
